...
public class FerryExceptions extends GeneralException {
    public static String ERROR_FERRY_NOT_ENOUGH_SPACE_FOR_VEHICLE_ON_FERRY = "ERROR.FERRY_NOT_ENOUGH_SPACE_FOR_VEHICLE_ON_FERRY";
    public static String ERROR_FERRY_CAPACITY_LESS_THAN_PEOPLE_NUMBER = "ERROR.FERRY_CAPACITY_LESS_THAN_PEOPLE_NUMBER";
